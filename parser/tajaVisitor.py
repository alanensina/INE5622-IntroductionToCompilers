# Generated from parser/taja.g4 by ANTLR 4.9.1
from antlr4 import *
...
class tajaVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by tajaParser#arguments_repeat.
    def visitArguments_repeat(self, ctx:tajaParser.Arguments_repeatContext):
        return self.visitChildren(ctx)
